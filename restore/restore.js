document.addEventListener('DOMContentLoaded', () => {
    ...
    const API_URL = 'https://hiwa-tenko-backend.onrender.com/api/reports';  //supabase backend
    ...
    */
    ...
    if (restoreButton) {
        restoreButton.addEventListener('click', () => {
            ...
            //ここに、サーバ（GAS_WEB_APP_URL からsupabaseのAPI_URL）から
            //ログインユーザの15日間のデータを取得する
            //取得したデータをLocalStrageの履歴を上書き保存する
